...
function IARegistrationPage() {
  ...
  async function uploadImage(e) {
    ...
    console.log(document.getElementById("profilePhoto").files[0].name);
    setFileName(document.getElementById("profilePhoto").files[0].name);
  ...
  async function handleUpload() {
    ...
    setFormData({ ...formData, profilePhoto: image_cid });
  ...
  const handleSubmit = async (img_cid) => {
    try {
      ...
      const tx = await contract.setAuthority(
        formData.fullName,
        formData.email,
        formData.country,
        img_cid,
  ...
  return (
    <div className="ia-register-main-container">
      <div className="ia-register-registration-container">
        <div className="ia-register-form">
          <div className="ia-register-registration-header">
            <div className="ia-register-registration-title">
          ...
          <div className="ia-register-form-group">
            <label htmlFor="profilePhoto">Choose Profile Picture - </label>
            <input
              type="file"
              id="profilePhoto"
              name="profilePhoto"
...
export default IARegistrationPage;
